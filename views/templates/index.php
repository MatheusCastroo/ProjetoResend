<div class="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
    <div>
        ...
        <p class="mt-1 text-slate-400 text-sm">Application: <span class="text-indigo-300 font-medium"><?= e($application['nome']) ?></span></p>
    </div>
...
<div class="card-saas">
    <?php if (empty($templates)): ?>
        <div class="text-center py-12">
            ...
            <p class="muted-saas mt-2">Use <span class="code-inline">{{empresa}}</span>, <span class="code-inline">{{nome}}</span>, etc.</p>
            <a class="btn-saas btn-saas--primary mt-4" href="<?= e(base_url('templates/novo?application_id=' . (int)$application['id'])) ?>">Criar template</a>
        </div>
    <?php else: ?>
